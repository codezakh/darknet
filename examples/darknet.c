...
extern void test_detector_scriptable(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen);
...
int main(int argc, char **argv)
{
	...
	} else if (0 == strcmp(argv[1], "pibbles")){
        float thresh = find_float_arg(argc, argv, "-thresh", .5);
        char *filename = (argc > 4) ? argv[4]: 0;
        char *outfile = find_char_arg(argc, argv, "-out", 0);
        int fullscreen = find_arg(argc, argv, "-fullscreen");
        test_detector_scriptable("cfg/coco.data", argv[2], argv[3], filename, thresh, .5, outfile, fullscreen);
